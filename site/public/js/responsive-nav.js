...
var bigSearch='<form class="navbar-form navbar-right" action="/search.html" method="get"><span class="search-form"><input type="text" name="searchData" class="form-control" id="searchInput" placeholder="Search"/></span><span class="search-button"><button type="submit" class="btn btn-default">Search</button></span></form>';
...
var smallSearch='<form class="navbar-form navbar-right" action="/search.html" method="get"><div class="form-group" id="inline-search"><div class="col-xs-8"><input type="text" name="searchData" class="form-control" id="searchInput" placeholder="Search"/></div><div class="cl-xs-3"><button type="submit" class="btn btn-default">Search</button></div></div></form>';
